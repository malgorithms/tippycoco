...
//
class BlackAi extends base_1.AiBase {
    hiddenWhiteBrain;
    constructor(game) {
        super(game);
        this.hiddenWhiteBrain = new white_ai_1._WhiteAi(game);
    }
    get skyTextureNames() {
        return {
    ...
    think(o) {
        ...
        const amLeft = o.me.playerSide === types_1.PlayerSide.Left;
